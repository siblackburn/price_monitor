...
#             url = response.urljoin(href.extract())  # returns a url like duluxdecoratorcentre.co.uk/products/paint
...
#         # Create a dictionary of items by their product ID. I do this because when I fetch the price information
...
#         url_l2_unformated = url_l2_reg.findall(url_l3)
#         url_l2 = str(url_l2_unformated).replace("[", "").replace("]", "").replace("'", "")
#         url_l1 = response.meta.get('url_l1')
